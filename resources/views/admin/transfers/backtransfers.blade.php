        ...
        <div class="card">
          <div class="card-header">
            <div class="row align-items-center">
              <div class="col-8">
                <h3 class="mb-0">{{$backtransfers->transfer_name}}</h3>
              </div>
            ...
            <form method="POST" action="" enctype="multipart/form-data">
              ...
              <div class="table-responsive">
                <table class="table align-items-center table-flush">
                  ...
                  <tbody class="list">
                    @foreach ($transferproos as $key=>$transferpro)
                    ...
                    <tr>
                      ...
                      <td>
                        <span class="badge badge-dot mr-4">
                          <i class="bg-success"></i>
                          <span class="status">{{ $transferpro->product_cost }}</span>
                        </span>
                      </td>
                      <td>
                        <span class="badge badge-dot mr-4">
                      ...
                      <td>
                        <span class="badge badge-dot mr-4">
                          <i class="bg-success"></i>
                          <span class="status">{{ $transferpro->product_quantity }}</span>
                        </span>
                      </td>
                      <td>
                        <span class="badge badge-dot mr-4">
