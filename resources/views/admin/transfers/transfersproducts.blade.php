    ...
    <div class="card">
      ...
      <div class="card-header border-0">
        <div class="row align-items-center">
          <div class="col-8">
            <h3 class="mb-0">Transfers Products </h3>
          </div>
          <div class="col-4 text-right">

    
              <button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#modal-form">Add Transfers Products</button>
        ...
        <div class="card bg-secondary border-0 mb-0">
            <div class="card-body px-lg-5 py-lg-5">
                <div class="text-center text-muted mb-4">
                  <h3 class="mb-0">Add Transfers Products</h3>
                </div>
                <form role="form" method="POST" action="{{ route('add.transfersproducts') }}">
                  @csrf
      ...
      <div class="table-responsive">
        <table class="table align-items-center table-flush">
          ...
          <tbody class="list">
           @foreach ($transfersproducts as $key=>$row)
            <tr>
              {{--  <th scope="row">
              ...
              <td class="text-right">
                      <a href="{{ URL::to('/admin/edit/transfersproducts/'.$row->id) }}"   class="table-action" data-toggle="tooltip" data-original-title="Edit Transfer Products"><i class="fas fa-user-edit"></i></a>
                      <a href="{{ URL::to('/admin/delete/transfersproducts/'.$row->id) }}" onclick="return confirm('Are you sure to delete {{ $row->product_name }} Transfer Products?')" type="button" class="table-action table-action-delete"  style="padding-left: 25%" data-toggle="tooltip" data-original-title="Delete Transfer Products"><i class="fas fa-trash"></i></a>
              </td>
            </tr>
      ...
      <div class="card-footer py-4">
        {{ $transfersproducts->links("pagination::bootstrap-4") }}
